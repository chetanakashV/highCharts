...
var urlWeekDay = "https://b681faa2-f217-44fd-9a41-94c7fe1cdf22.mock.pstmn.io/getInspectionsDW"; 
var urlMonthYear = "https://b681faa2-f217-44fd-9a41-94c7fe1cdf22.mock.pstmn.io/getInspectionsMY"; 
        ...
        Axios.get(urlWeekDay).then(response =>{
                ...
                if(dataEl.location === location)  
            {
                dataEl.data.forEach((key, index) => {
                    ...
                    series1.push( [ weekDays[dat.getDay()] ,key.locations_inspected] );  
                })
            }
            })
            return "done"; 
        ...
        Axios.get(urlMonthYear).then(response =>{
                ...
                if(dataEl.location === location)  
            {
                dataEl.data.forEach((key, index) => {
                    ...
                    series1.push( [ key.month ,key.locations_inspected] ); 
                })
