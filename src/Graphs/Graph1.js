        ...
        Axios.get(urlWeekDay).then(response =>{
                ...
                if(dataEl.location === location)  
            {
                dataEl.data.forEach((key, index) => {
                    ...
                    series1.push( [ weekDays[dat.getDay()] ,key.expected_inspections] ); 
                    series2.push( [ weekDays[dat.getDay()] ,key.completed_inspections] ); 
                })
        ...
        Axios.get(urlMonthYear).then(response =>{
                ...
                if(dataEl.location === location)  
            {
                dataEl.data.forEach((key, index) => {
                    ...
                    series1.push( [ key.month ,key.expected_inspections] ); 
                    series2.push( [ key.month ,key.completed_inspections] ); 
                })
